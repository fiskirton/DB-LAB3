...
1) БД находится в первой нормальной форме, т.к. значениях во всех полей неделимы(для каждого поля одно значение).
...
## Установка
Для установки необходимо создать пользователя и базуданных с одинаковыми названиями. Также необходимо добавить данные для входа и название базы данных пользователя в переменные среды (PGUSER, PGPASSWORD, PGDATABASE).
